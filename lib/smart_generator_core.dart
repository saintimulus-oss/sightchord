...
part 'music/smart_generator/smart_generator_analysis.dart';
part 'music/smart_generator/smart_generator_selection.dart';
part 'music/smart_generator/smart_generator_voice_leading.dart';
...
class SmartGeneratorHelper {
  ...
  static SmartTransitionSelection selectNextRoman({
    ...
    return _selectNextRoman(
      random: random,
      currentRomanNumeralId: currentRomanNumeralId,
      allowedRomanNumerals: allowedRomanNumerals,
      currentKeyMode: currentKeyMode,
    );
  }
  ...
  static List<String> findCompatibleModulationKeys({
    ...
    return _findCompatibleModulationKeys(
      activeKeys: activeKeys,
      currentKey: currentKey,
      targetSemitone: targetSemitone,
      keyTonicSemitoneResolver: keyTonicSemitoneResolver,
    );
  }
  ...
  static SmartCandidateComparison compareVoiceLeadingCandidates({
    ...
    return _compareVoiceLeadingCandidates(
      random: random,
      ...
      debugChordStyle: debugChordStyle,
    );
  }
  ...
  static SmartSimulationComparison compareSimulationSummaries({
    ...
    return _compareSimulationSummaries(
      baseline: baseline,
      candidate: candidate,
    );
  }
