...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get accountCardSignedOutBody =>
      '로그인하면 프리미엄을 계정에 연결하고 다른 기기에서도 복원할 수 있습니다.';

  @override
  String accountCardSignedInBody(Object email) {
    return '$email 계정으로 로그인되어 있습니다. 이제 프리미엄 동기화와 복원이 이 계정을 기준으로 동작합니다.';
  }

  @override
  String get accountCardUnavailableBody =>
      '이 빌드에는 아직 계정 기능이 설정되지 않았습니다. 로그인 기능을 쓰려면 Firebase 런타임 설정이 필요합니다.';

  @override
  String get accountOpenButton => '로그인';

  @override
  String get accountManageButton => '계정 관리';

  @override
  String get accountEmailLabel => '이메일';

  @override
  String get accountPasswordLabel => '비밀번호';

  @override
  String get accountSignInButton => '로그인';

  @override
  String get accountCreateButton => '계정 만들기';

  @override
  String get accountSwitchToCreateButton => '새 계정 만들기';

  @override
  String get accountSwitchToSignInButton => '이미 계정이 있어요';

  @override
  String get accountForgotPasswordButton => '비밀번호 재설정';

  @override
  String get accountSignOutButton => '로그아웃';

  @override
  String get accountMessageSignedIn => '로그인되었습니다.';

  @override
  String get accountMessageSignedUp => '계정이 만들어졌고 바로 로그인되었습니다.';

  @override
  String get accountMessageSignedOut => '이 계정에서 로그아웃했습니다.';

  @override
  String get accountMessagePasswordResetSent => '비밀번호 재설정 이메일을 보냈습니다.';

  @override
  String get accountMessageInvalidCredentials => '이메일과 비밀번호를 확인한 뒤 다시 시도해 주세요.';

  @override
  String get accountMessageEmailInUse => '이미 사용 중인 이메일입니다.';

  @override
  String get accountMessageWeakPassword => '계정을 만들려면 더 강한 비밀번호를 사용해 주세요.';

  @override
  String get accountMessageUserNotFound => '해당 이메일로 등록된 계정을 찾지 못했습니다.';

  @override
  String get accountMessageTooManyRequests =>
      '지금은 시도가 너무 많습니다. 잠시 후 다시 시도해 주세요.';

  @override
  String get accountMessageNetworkError => '네트워크 요청에 실패했습니다. 연결 상태를 확인해 주세요.';

  @override
  String get accountMessageAuthUnavailable =>
      '이 빌드에는 아직 계정 로그인 기능이 설정되지 않았습니다.';

  @override
  String get accountMessageUnknownError => '계정 요청을 완료하지 못했습니다.';

  @override
  String get accountDeleteButton => '계정 삭제';

  @override
  String get accountDeleteDialogTitle => '계정을 삭제할까요?';

  @override
  String accountDeleteDialogBody(Object email) {
    return '$email 계정과 연결된 Chordest 계정을 영구적으로 삭제하고, 동기화된 프리미엄 데이터도 함께 지웁니다. 스토어 구매 기록은 Google Play 또는 App Store 계정에 남습니다.';
  }

  @override
  String get accountDeletePasswordHelper => '삭제를 확인하려면 현재 비밀번호를 입력해 주세요.';

  @override
  String get accountDeleteConfirmButton => '영구 삭제';

  @override
  String get accountDeleteCancelButton => '취소';

  @override
  String get accountDeletePasswordRequired => '이 계정을 삭제하려면 현재 비밀번호를 입력해 주세요.';

  @override
  String get accountMessageDeleted => '계정과 동기화된 프리미엄 데이터가 삭제되었습니다.';

  @override
  String get accountMessageDeleteRequiresRecentLogin =>
      '보안을 위해 현재 비밀번호를 다시 입력한 뒤 삭제를 시도해 주세요.';

  @override
  String get accountMessageDataDeletionFailed =>
      '동기화된 계정 데이터를 지우지 못했습니다. 잠시 후 다시 시도해 주세요.';

  @override
  String get premiumUnlockAccountSyncTitle => '계정 동기화';

  @override
  String get premiumUnlockAccountSyncSignedOutBody =>
      '프리미엄을 이 기기에서 계속 쓸 수는 있지만, 로그인하면 이 잠금 해제가 계정을 따라 다른 기기에도 이어집니다.';

  @override
  String premiumUnlockAccountSyncSignedInBody(Object email) {
    return '$email 계정으로 로그인되어 있을 때 프리미엄 구매와 복원이 이 계정에 동기화됩니다.';
  }

  @override
  String get premiumUnlockAccountSyncUnavailableBody =>
      '이 빌드에는 아직 계정 동기화가 설정되지 않아 프리미엄이 현재 기기에만 저장됩니다.';
