            ...
            actions: [
              Padding(
                ...
                child: Row(
                  ...
                  children: List.generate(lesson.startingLives, (index) {
                    ...
                    return Padding(
                      ...
                      child: Icon(
                        ...
                        key: ValueKey('study-harmony-life-${index + 1}'),
                        color: isAlive
                              ...
                              child: Column(
                                ...
                                children: [
                                  _SessionOverviewCard(
                                    ...
                                    objectiveLabel: l10n.studyHarmonyObjective,
                                  ),
                                  const SizedBox(height: 16),
                                  _PromptCard(
                                    task: task,
                                    instructionLabel:
                                        l10n.studyHarmonyPromptInstruction,
                                  ),
                                  const SizedBox(height: 16),
                                  if (state.lastEvaluation.status !=
                                    ...
                                    Padding(
                                      ...
                                      child: _FeedbackBanner(
                                        ...
                                        correctLabel:
                                            l10n.studyHarmonyCorrectLabel,
                                        incorrectLabel:
                                            l10n.studyHarmonyIncorrectLabel,
                                        selectionLabel:
                                            l10n.studyHarmonyNeedSelection,
                                        correctMessage: (answer) =>
                                            l10n.studyHarmonyCorrectFeedback(
                                              answer,
                                            ),
                                  ...
                                  Card(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(20),
                                      child: _buildAnswerSurface(task, state),
                                    ),
                                  ),
                                  const SizedBox(height: 16),
                                  _SelectionPanel(
                                    ...
                                    emptyLabel: l10n.studyHarmonySelectionEmpty,
                                    selectionLabel:
                                        l10n.studyHarmonySelectedAnswers,
                                    submitLabel: l10n.studyHarmonySubmit,
                      ...
                      child: Padding(
                        ...
                        child: ConstrainedBox(
                          ...
                          child: _ResultOverlay(
                            ...
                            progressLabel: l10n.studyHarmonyClearProgress(
                              state.correctAnswers,
                              lesson.goalCorrectAnswers,
                            ),
                            accuracyLabel:
                            ...
                            dailyDateLabel:
                                _lastProgressEffect?.dailyDateKey == null
                                ? null
                            ...
                            focusSkillLabels: [
                              for (final skillId
                                  in (_lastProgressEffect?.focusSkillTags ??
  ...
  Widget _buildAnswerSurface(
    ...
    return switch (task.answerSurface) {
      StudyHarmonyAnswerSurfaceKind.pianoKeyboard => StudyHarmonyPianoKeyboard(
        ...
        readOnly: state.isFinished,
      ),
      StudyHarmonyAnswerSurfaceKind.choiceChips => Wrap(
        spacing: 12,
        runSpacing: 12,
        children: task.choiceOptions
            .map(
              (choice) => FilterChip(
                key: ValueKey('study-harmony-choice-${choice.id}'),
                label: Text(choice.label),
                selected: state.selectedAnswerIds.contains(choice.id),
                onSelected: state.isFinished
                    ? null
                    : (_) => _toggleAnswer(choice.id),
              ),
            )
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  if (explanationDetail != null && explanationDetail.isNotEmpty)
                    Padding(
