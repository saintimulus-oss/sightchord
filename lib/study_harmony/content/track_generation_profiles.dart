  ...
  return TrackSoundProfile(
    ...
    runtimeProfile: HarmonyAudioRuntimeProfile(
      ...
      tuning: const HarmonyAudioProfileTuning(
        ...
        velocityHumanizationFloor: 0.12,
        gainRandomnessFloor: 0.1,
  ...
  return TrackSoundProfile(
    ...
    runtimeProfile: HarmonyAudioRuntimeProfile(
      ...
      tuning: const HarmonyAudioProfileTuning(
        ...
        velocityHumanizationFloor: 0.2,
        gainRandomnessFloor: 0.14,
  ...
  return TrackSoundProfile(
    ...
    runtimeProfile: HarmonyAudioRuntimeProfile(
      ...
      tuning: const HarmonyAudioProfileTuning(
        ...
        velocityHumanizationFloor: 0.05,
        gainRandomnessFloor: 0.02,
